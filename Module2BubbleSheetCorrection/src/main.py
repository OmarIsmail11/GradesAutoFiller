...
# -------------------------------
# 1) Load paper, extract ID and answers
# -------------------------------
...
questions = paper[height//3:, :, :]

# Extract ID and answers
student_id = extract_id(idImage)
student_answers = extract_answers_from_area(questions)

student_answers = ['A', 'B', 'C', 'C', 'X', 'Z', 'X', 'X', 'C', 'C', 'C', 'B', 'B']
