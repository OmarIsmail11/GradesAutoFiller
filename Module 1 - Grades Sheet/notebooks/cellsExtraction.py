...
def get_cells_as_images(image, min_cell_width=30, min_cell_height=20):
    """
    Returns a list of rows, where each row is a list of cropped cell images.
    Uses the same table detection logic as before.
    """
    rows = detect_table_cells(image, min_cell_width, min_cell_height)
    cells_images = []
    ...
    for row in rows:
        ...
        cells_images.append(row_images)
